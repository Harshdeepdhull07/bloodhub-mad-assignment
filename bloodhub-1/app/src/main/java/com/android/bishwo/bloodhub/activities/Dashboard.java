...
import com.android.bishwo.bloodhub.fragments.appointment;
import com.android.bishwo.bloodhub.fragments.doctor;
...
public class Dashboard extends AppCompatActivity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.doc) {
            getSupportFragmentManager().beginTransaction().replace(R.id.fragmentcontainer, new doctor()).commit();
        }
        if (id == R.id.app) {
            getSupportFragmentManager().beginTransaction().replace(R.id.fragmentcontainer, new appointment()).commit();
        }
