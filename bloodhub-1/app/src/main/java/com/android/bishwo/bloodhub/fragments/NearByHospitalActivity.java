...
public class NearByHospitalActivity extends Fragment implements
    ...
    private int PROXIMITY_RADIUS = 10000; // Default radius
    ...
    public void onLocationChanged(Location location) {
        ...
        // Adjust the zoom level to zoom in closer to the current location
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(latLng, 15));
        mMap.animateCamera(CameraUpdateFactory.zoomBy(10), 2000, null);
    }
