...
public class ProfileActivity extends AppCompatActivity {
    ...
    private CheckBox opt, opt1, opt2, opt3, opt4, opt5, opt6, opt7, opt8, opt9, isDonor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        opt7 = findViewById(R.id.opt7);
        opt8 = findViewById(R.id.opt8);
        opt9 = findViewById(R.id.opt9);
                        ...
                        donor.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                if (dataSnapshot.exists()) {
                                    ...
                                    Toast.makeText(ProfileActivity.this, "You are not a donor! Be a donor and save lives by donating blood.",
        ...
        btnSignup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    } else if (!opt.isChecked() && !opt1.isChecked() && !opt2.isChecked() && !opt3.isChecked() && !opt4.isChecked() &&
                            !opt5.isChecked() && !opt6.isChecked() && !opt7.isChecked() && !opt8.isChecked() && !opt9.isChecked()) {
                        Toast.makeText(ProfileActivity.this, "Please answer all the questions.", Toast.LENGTH_SHORT).show();
                    } else {
                        if (!isUpdate) {
                            if (email.length() == 0) {
                                ShowError("Email ID");
                                        ...
                                        .addOnCompleteListener(ProfileActivity.this, new OnCompleteListener<AuthResult>() {
                                            ...
                                            public void onComplete(@NonNull Task<AuthResult> task) {
                                                ...
                                                if (!task.isSuccessful()) {
                                                    ...
                                                    db_ref.child("Contact").setValue(Contact);
